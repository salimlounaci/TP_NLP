...
def test_end_to_end():
    ...
    data_test = pd.read_csv('./data/bid_requests_test.csv')  # Changez ce chemin selon votre structure de dossier
    # Charger les résultats attendus
    result_expected = pd.read_csv('./data/expected_results.csv')  # Changez ce chemin selon votre structure de dossier
    ...
    result = predict('./data/bid_requests_test.csv')
